...
import "codemirror/addon/edit/closebrackets";
     ...
     */
    export function createCodeEditorComponent(React) {
        ...
        const CodeEditor = ({ value, onChange, placeholder }) => {
            ...
            useEffect(() => {
                ...
                cmInstance.current = CodeMirror.fromTextArea(editorRef.current, {
	                ...
	                cmInstance.current.setSize(null, "480px");
     ...
     */
    export function getNodeDimensions(nodeModel) {
     ...
     * @returns {string} 颜色值
     */
    export function getNodeColor(nodeModel) {
        if (nodeModel.type === 'entity') {
            return '#0ea5e9'; // 蓝色
        } else if (nodeModel.type === 'relationship') {
            return '#722ed1'; // 紫色
     ...
     */
    export function setupNodeDoubleClickEdit(graph, container, options) {
