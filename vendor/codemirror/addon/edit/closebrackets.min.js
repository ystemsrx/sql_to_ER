!(function (e) {
  ...
  function y(e, t) {
    return "pairs" == t && "string" == typeof e
      ? e
      : ("object" == typeof e && null != e[t] ? e : n)[t];
  }
  S.defineOption("autoCloseBrackets", !1, function (e, t, n) {
    (n && n != S.Init && (e.removeKeyMap(i), (e.state.closeBrackets = null)),
      t && (r(y(t, "pairs")), (e.state.closeBrackets = t), e.addKeyMap(i)));
  });
  var i = {
    Backspace: function (e) {
      ...
      for (
        var n = y(t, "pairs"), r = e.listSelections(), i = 0;
        i < r.length;
        i++
      ) {
          ...
          return function (e) {
            ...
            for (
              ...
              if (h && !d.empty()) u = "surround";
                ...
                if (
                  ...
                  1 < p.ch &&
                  0 <= s.indexOf(t) &&
                  i.getRange(k(p.line, p.ch - 2), p) == t + t
                ) {
                  if (
                    2 < p.ch &&
                    /\bstring/.test(i.getTokenTypeAt(k(p.line, p.ch - 2)))
                  )
                    return S.Pass;
                  u = "addFour";
                } else if (l) {
                  d = 0 == p.ch ? " " : i.getRange(k(p.line, p.ch - 1), p);
                  if (S.isWordChar(g) || d == t || S.isWordChar(d))
                    return S.Pass;
                  u = "both";
                } else {
                  if (
                ...
                u =
                  ...
                  (function (e, t) {
                    ...
                    ? "both"
                    : 0 <= s.indexOf(t) &&
                        i.getRange(p, k(p.line, p.ch + 3)) == t + t + t
                      ? "skipThree"
                      : "skip";
              if (a) {
            ...
            i.operation(function () {
              if ("skip" == a) m(i, 1);
                ...
                for (var e = i.getSelections(), t = 0; t < e.length; t++)
                  e[t] = v + e[t] + b;
                i.replaceSelections(e, "around");
                for (e = i.listSelections().slice(), t = 0; t < e.length; t++)
                  e[t] =
                    ((n = e[t]),
                    (r = void 0),
                    (r = 0 < S.cmpPos(n.anchor, n.head)),
                    {
                ...
                "both" == a
                  ? (i.replaceSelection(v + b, null),
                    ...
                    m(i, -1))
                  : "addFour" == a &&
                    (i.replaceSelection(v + v + v + v, "before"), m(i, 1));
              var n, r;
            });
          };
        })(n));
